...
const translations: Record<Language, Translations> = {
  ru: {
    ...
    popularAssetsDesc: {
      ru: "Изучите разнообразные токенизированные активы в нашем маркетплейсе",
      en: "Explore diverse tokenized assets in our marketplace",
      zh: "在我们的市场中探索各种代币化资产",
      hi: "हमारे मार्केटप्लेस में विविध टोकनाइज़्ड संपत्तियों का अन्वेषण करें",
      ar: "استكشف الأصول المرمزة المتنوعة في السوق لدينا",
      pt: "Explore ativos tokenizados diversos em nosso marketplace",
      bn: "আমাদের মার্কেটপ্লেসে বিভিন্ন টোকেনাইজড সম্পদ অন্বেষণ করুন",
      es: "Explore activos tokenizados diversos en nuestro mercado",
      fr: "Explorez des actifs tokenisés divers dans notre place de marché",
      ur: "ہمارے مارکیٹ پلیس میں متنوع ٹوکنائزڈ اثاثے دریافت کریں"
    },
    luxuryApartmentNYC: {
      ru: "Роскошная квартира в Нью-Йорке",
      en: "Luxury Apartment NYC",
      zh: "纽约豪华公寓",
      hi: "न्यूयॉर्क लक्जरी अपार्टमेंट",
      ar: "شقة فاخرة في نيويورك",
      pt: "Apartamento de Luxo NYC",
      bn: "নিউইয়র্ক বিলাসবহুল অ্যাপার্টমেন্ট",
      es: "Apartamento de Lujo NYC",
      fr: "Appartement de Luxe NYC",
      ur: "نیویارک لکچری اپارٹمنٹ"
    },
    commercialOfficeSpace: {
      ru: "Коммерческое офисное пространство",
    ...
    totalAssetValue: {
      ...
      ar: "إجمالي قيمة الأصول",
      pt: "Valor Total do Ativo",
      bn: "মোট সম্পদের মূল্য",
  ...
  ar: {
    ...
    heroSubtitle: 'حوّل العقارات والسلع والأصول الأخرى إلى رموز رقمية باستخدام تقنية البلوك تشين',
    ...
    highLiquidityDesc: 'تاجر الأصول 24/7 على منصة لامركزية',
    security: 'الأمان',
    ...
    marketplaceDesc: 'تاجر الأصول المرمزة في بيئة لامركزية',
    ...
    step4Title: 'ترميز الأصول',
    step4Description: 'تاجر الرموز في السوق',
    ...
    // Asset creation
    connectMetaMask: 'MetaMask ربط',
    connectWalletToCreateAsset: 'يرجى ربط محفظتك لإنشاء أصل',
    back: 'عودة',
    realEstate: 'عقارات',
    goods: 'سلع',
    art: 'فن',
    ...
    perToken: 'لكل توكن',
    tokenLimitInfo: 'القيمة الإجمالية توزع بين توكنات AST و AGT و ABT',
    creatingAsset: 'جارٍ إنشاء الأصل...',
    createAsset: 'إنشاء أصل',
    success: 'نجاح',
    assetCreatedSuccessfully: 'تم إنشاء الأصل بنجاح مع توكنات',
    error: 'خطأ',
    ...
    tradeAssetTokens: 'تاجر توكنات الأصول',
    loans: 'القروض',
    loansWithTokenCollateral: 'قروض بضمان توكن',
    defiSwap: 'DeFi تبديل',
    exchangeTokens: 'تبديل توكنات',
    open: 'فتح',
