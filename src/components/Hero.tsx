      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 fade-in-up">
            Токенизируйте{" "}
            <span className="gradient-text neon-text">реальные активы</span>{" "}
            в будущем
          </h1>
          
          {/* Подзаголовок */}
          <p className="text-xl md:text-2xl text-muted-foreground mb-8 fade-in-up" style={{animationDelay: "0.2s"}}>
            Cosmo RWA — первая децентрализованная платформа для токенизации недвижимости, 
            товаров и других активов с автоматическим созданием трех уникальных токенов
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12 fade-in-up" style={{animationDelay: "0.4s"}}>
            <div className="text-center">
              ...
              <div className="text-muted-foreground">Лимит токенов на актив</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-purple-400 mb-2">90%</div>
              <div className="text-muted-foreground">Стабильные токены (AST)</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-green-400 mb-2">24/7</div>
              <div className="text-muted-foreground">Торговля активами</div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 fade-in-up" style={{animationDelay: "0.8s"}}>
            <div className="asset-card p-6 rounded-xl">
              ...
              <h3 className="text-xl font-semibold mb-2">Высокая ликвидность</h3>
              <p className="text-muted-foreground">
                Создавайте пулы ликвидности для всех трех типов токенов
              </p>
            </div>
            ...
            <div className="asset-card p-6 rounded-xl">
              ...
              <p className="text-muted-foreground">
                Смарт-контракты обеспечивают прозрачность и безопасность сделок
              </p>
            </div>
            
            <div className="asset-card p-6 rounded-xl">
              <Coins className="h-12 w-12 text-green-400 mb-4 mx-auto" />
              <h3 className="text-xl font-semibold mb-2">Тройная токенизация</h3>
              <p className="text-muted-foreground">
                Стабильные (90%), поддержки (9%) и брендовые (1%) токены
              </p>
            </div>
          </div>
        </div>
